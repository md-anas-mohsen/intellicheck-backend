const registrationRequestEmailTemplate = ({ teacherName, className }) => {
  return `
    <!doctype html>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin: 0; padding: 0; vertical-align: top;" width="100%" valign="top">
                        ...
                        <tr style="margin: 0; padding: 0;">
                            ...
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                                <h1 style="margin: 0; padding: 0; font-size: 2.5em;">Register now!</h1>
                                <p style="margin: 0; padding: 0; font-size: 1.4em;"><strong style="margin: 0; padding: 0;">${teacherName}</strong> has invited you to join <strong style="margin: 0; padding: 0;">${className}</strong> on RapidCheck.</p>
                                <p style="margin: 0; padding: 0; font-size: 1.4em;">Download the app now to get started!</p>
                            </div>
                            </td>
                        </tr>
                        <tr style="margin: 0; padding: 0;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin: 0; padding: 0; border-collapse: collapse; border-spacing: 0px;">
                                <tbody style="margin: 0; padding: 0;">
                                <tr style="margin: 0; padding: 0;">
                                    <td style="margin: 0; padding: 0; width: 200px;" width="200">
                                    <img height="auto" src="https://res.cloudinary.com/clicktobuy/image/upload/v1684847465/app-store-google-play-logo-4A2747BF5E-seeklogo.com_omppdt.png" style="margin: 0; padding: 0; border: 0; display: block; outline: none; text-decoration: none; height: auto; width: 100%; font-size: 13px;" width="200">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
...
module.exports = registrationRequestEmailTemplate;
