const assessmentCreatedEmailTemplate = ({
  className,
  assessmentName,
  totalMarks,
  duration,
                        ...
                        <tr style="margin: 0; padding: 0;">
                          <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                              <h1 style="margin: 0; padding: 0; font-size: 2.5em;">New Assessment Posted!</h1>
                            </div>
                          </td>
                        </tr>
                        <tr style="margin: 0; padding: 0;">
                          <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                              <p style="margin: 0; padding: 0; font-size: 1.4em;">A new assessment <strong style="margin: 0; padding: 0;">${assessmentName}</strong></p>
                              <p style="margin: 0; padding: 0; font-size: 1.4em;">has been posted in <strong style="margin: 0; padding: 0;">${className}</strong></p>
                            </div>
                          </td>
                        </tr>
                        <tr style="margin: 0; padding: 0;">
                          <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                              <p style="margin: 0; padding: 0; font-size: 1.4em;"><strong style="margin: 0; padding: 0;">Marks: </strong> ${totalMarks}</p>
                              <p style="margin: 0; padding: 0; font-size: 1.4em;"><strong style="margin: 0; padding: 0;">Duration: </strong> ${duration} minute(s)</p>
                            </div>
                          </td>
                        </tr>
                        <tr style="margin: 0; padding: 0;">
...
module.exports = assessmentCreatedEmailTemplate;
