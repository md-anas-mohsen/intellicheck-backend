const announcementPostedEmailTemplate = ({
  announcementTitle,
                        ...
                        <tr style="margin: 0; padding: 0;">
                          <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                              <h1 style="margin: 0; padding: 0; font-size: 2.5em;">${announcementTitle}</h1>
                            </div>
                          </td>
                        </tr>
                        <tr style="margin: 0; padding: 0;">
                          <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                              <p style="margin: 0; padding: 0; font-size: 1.4em;">${announcementDescription}</p>
                            </div>
                          </td>
                        </tr>
                        <tr style="margin: 0; padding: 0;">
                          <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                              <p style="margin: 0; padding: 0; font-size: 1.4em;">Posted by,</p>
                              <p style="margin: 0; padding: 0; font-size: 1.4em;">${teacherName}</p>
                            </div>
                          </td>
                        </tr>
                      </tbody>
...
module.exports = announcementPostedEmailTemplate;
