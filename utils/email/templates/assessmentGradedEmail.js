const assessmentGradedEmailTemplate = ({
  className,
  assessmentName,
  obtainedMarks,
  totalMarks,
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin: 0; padding: 0; vertical-align: top;" width="100%" valign="top">
                      <tbody style="margin: 0; padding: 0;">
                        <tr style="margin: 0; padding: 0;">
                          <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                              <h1 style="margin: 0; padding: 0; font-size: 2.5em;">Assessment Graded!</h1>
                            </div>
                          </td>
                        </tr>
                        <tr style="margin: 0; padding: 0;">
                          <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                              <p style="margin: 0; padding: 0; font-size: 1.4em;">You scored</p>
                            </div>
                          </td>
                        </tr>
                        <tr style="margin: 0; padding: 0;">
                        ...
                        <tr style="margin: 0; padding: 0;">
                          <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                            <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                              <p style="margin: 0; padding: 0; font-size: 1.4em;">on <strong style="margin: 0; padding: 0;">${assessmentName}</strong> in <strong style="margin: 0; padding: 0;">${className}</strong></p>
                            </div>
                          </td>
                        </tr>
                        <tr style="margin: 0; padding: 0;">
...
module.exports = assessmentGradedEmailTemplate;
