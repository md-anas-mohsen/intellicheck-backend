const forgotPasswordOTPEmailTemplate = ({ code }) => {
  return `
        <!doctype html>
                    ...
                    <div class="mj-column-per-100 mj-outlook-group-fix" style="margin: 0; padding: 0; font-size: 0px; text-align: left; direction: ltr; display: inline-block; vertical-align: top; width: 100%;">
                        ...
                        <tbody style="margin: 0; padding: 0;">
                            ...
                            <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                                ...
                                <h1 style="margin: 0; padding: 0; font-size: 2.5em;">Forgot Password OTP</h1>
                                </div>
                            </td>
                            </tr>
                            <tr style="margin: 0; padding: 0;">
                            <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                                <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                                <p style="margin: 0; padding: 0; font-size: 48px;"><strong style="margin: 0; padding: 0;">${code}</strong></p>
                                </div>
                            </td>
                            </tr>
                            <tr style="margin: 0; padding: 0;">
                            <td align="center" style="margin: 0; font-size: 0px; padding: 10px 25px; word-break: break-word;">
                                <div style="margin: 0; padding: 0; font-family: Montserrat, sans-serif; font-size: 13px; line-height: 1; text-align: center; color: #000000;">
                                <p style="margin: 0; padding: 0; font-size: 1.4em;">Use the code above to reset your password</p>
                                <p style="margin: 0; padding: 0; font-size: 1.4em;">If you did not generate this request then please ignore this email.</p>
                                </div>
                            </td>
                            </tr>
                            <tr style="margin: 0; padding: 0;">
...
module.exports = forgotPasswordOTPEmailTemplate;
